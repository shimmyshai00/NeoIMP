...
namespace SDF::Editor::UiLayer::Gui::Qt::MvcAdapter {
    ...
    namespace Impl {
        ...
        struct PassThru {
            ...
            Primitive operator()(const Primitive &a_rhs) { return a_rhs; }
        };
    }  // namespace Impl

    template <>
    struct Translate<bool> : Impl::PassThru<bool> {};
    template <>
    struct Translate<char> : Impl::PassThru<char> {};
    template <>
    struct Translate<short> : Impl::PassThru<short> {};
    template <>
    struct Translate<int> : Impl::PassThru<int> {};
    template <>
    struct Translate<long> : Impl::PassThru<long> {};
    template <>
    struct Translate<unsigned char> : Impl::PassThru<unsigned char> {};
    template <>
    struct Translate<unsigned short> : Impl::PassThru<unsigned short> {};
    template <>
    struct Translate<unsigned long> : Impl::PassThru<unsigned long> {};
    template <>
    struct Translate<float> : Impl::PassThru<float> {};
    template <>
    struct Translate<double> : Impl::PassThru<double> {};
